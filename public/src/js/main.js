...
(function() {
  ...
  /**
   * Função de adicionar event listener
   */
  ...
  /**
   * Alternar a classe .header-scrolled para o #header quando a página é rolada
   */
  ...
  /**
   * Redimensionamento automático de gráficos echart
   */
